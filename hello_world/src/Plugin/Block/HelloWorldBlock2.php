...
class HelloWorldBlock2 extends BlockBase {
  ...
  public function build() {
    ...
    $result = db_query("select n.title, u.uid, n.created from node_field_data n, users u where u.uid = n.uid and n.type = :type order by n.created desc limit 5", array("type" => "product"));
    $content = "";
